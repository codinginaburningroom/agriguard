-- ============================================================
-- AgriGuard — Re-create database with correct Thai encoding
-- วิธีรัน (สำคัญมาก ต้องใส่ --default-character-set):
--   mysql -u root -p --default-character-set=utf8mb4 < fix_thai_data.sql
-- ============================================================

SET NAMES 'utf8mb4' COLLATE 'utf8mb4_unicode_ci';

DROP DATABASE IF EXISTS agriguard;
CREATE DATABASE agriguard CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE agriguard;
...
('มะเขือเทศ','Tomato','vegetable'),
('ลำไย','Longan','fruit'),
('มันสำปะหลัง','Cassava','tuber'),
('อ้อย','Sugarcane','cash_crop'),
('ยางพารา','Rubber','cash_crop');
...
SELECT 'Done! ตรวจสอบ targets:' AS msg;
SELECT target_id, target_name_th, target_name_en FROM targets LIMIT 5;